...
<Info>
For better security, consider using AWS Systems Manager Session Manager instead of SSH, which doesn't require open ports and provides audit logging.
</Info>
...
- **Search** — Find findings by keyword or resource name
...
- Full security analysis and findings
